...
export const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      ['Chấm nâng cao Schreiben/Sprechen', false], ['Luyện phát âm trực tuyến', false], ['Phân tích phát âm chuyên sâu', false],
    ],
  },
  {
    ...
    features: [
      ['Toàn bộ tính năng Basis', true], ['20 lượt chấm hoặc hội thoại nâng cao', true], ['60 phút luyện phát âm', true],
  ...
  },
  {
    ...
    features: [
      ['Toàn bộ tính năng B2 Plus', true], ['60 lượt chấm hoặc hội thoại nâng cao', true], ['180 phút luyện phát âm', true],
  ...
  },
  {
    ...
    features: [
      ['Toàn bộ tính năng B2 Pro', true], ['150 lượt chấm hoặc hội thoại nâng cao', true], ['600 phút luyện phát âm', true],
